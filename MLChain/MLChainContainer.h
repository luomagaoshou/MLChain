...
#ifndef indexDisplayMode                                  
#define indexDisplayMode(...)  indexDisplayMode(@"setIndexDisplayMode:", (long long)metamacro_at(0, __VA_ARGS__))                                  
#endif
/**     ClassName-> UIScrollView                                
SEL:   setIndexDisplayMode: 'q'
     */
- (MLChain4UIScrollView *(^)())indexDisplayMode;
...
SEL:   setIndexDisplayMode: 'q'
     */
- (MLChain4UITableView *(^)())indexDisplayMode;
